...
export default function NavWorkoutTypePage() {
  ...
  const allWorkouts = useUserWorkouts('Nav');
    ...
    return (
      <div className="min-h-screen p-6 flex items-center justify-center">
        <GlassCard className="p-8 text-center">
          ...
          <LiquidButton onClick={() => router.push('/nav')}>
            Back to Dashboard
          </LiquidButton>
        </GlassCard>
      </div>
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Nav's {getWorkoutTypeLabel(workoutType).toLowerCase()} training sessions
                </p>
              </div>
            </div>
          </div>
          ...
          <LiquidButton
            icon={<Plus size={16} />}
            onClick={() => router.push(`/nav/workouts/add?type=${workoutType}`)}
          >
            ...
            <div className="space-y-4">
              {sortedWorkouts.map((workout, index) => (
                <motion.div
                  ...
                  onClick={() => router.push(`/nav/workouts/${workout.id}`)}
                >
